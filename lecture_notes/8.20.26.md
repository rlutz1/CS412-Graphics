try to not ask questions in class, go for office hours and email when possible.
...
with light, maybe 3 - 7 light bounces (3 for a laptop, 7 for a nice gpu)
...
mixing reflected light:
	...
	result is black if we mix them together
	**for materials that reflect light**
